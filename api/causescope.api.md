...
```json
{
  ...
  "exports": {
    ...
    "./adapters/react-query": {
      "types": "./types/adapters/react-query.d.ts",
      "import": "./dist/adapters/react-query.js"
    },
    "./adapters/zustand": {
      "types": "./types/adapters/zustand.d.ts",
...
### `types/adapters/react-query.d.ts`
