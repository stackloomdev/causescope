...
- Playwright selects elements across multiple routes, components, and files; changes state; validates exact source locations; switches selection directly; and exports traces. Separate React 18/Vite 6 and React 19/SWC scenarios verify both React generations and both official React transform paths end to end.
