  ...
  <section class="cs-hero" aria-labelledby="hero-title">
    <div class="cs-hero-copy">
      ...
      <div class="cs-actions">
        ...
        <a class="cs-button cs-button-secondary" href="https://stackblitz.com/fork/github/stackloomdev/causescope/tree/main/examples/stackblitz?title=CauseScope%20Live%20Lab">Try the live lab</a>
      </div>
